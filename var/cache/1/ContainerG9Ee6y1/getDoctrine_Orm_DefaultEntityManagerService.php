 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends App_Kernel1DebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost43af0bc', fn () => \EntityManagerGhost43af0bc::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
