 ...
 */
class getRouting_LoaderService extends App_Kernel1DebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader($container->load('getAnnotations_CachedReaderService'), '1');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, '1'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, '1'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, '1'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, '1'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, '1'));
